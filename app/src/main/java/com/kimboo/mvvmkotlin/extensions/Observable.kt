...
/**
 * rx.Observable extended function that knows how to subscribe queryAlcoholic DataSourceSubscriber
 */
...
/**
 * Is queryAlcoholic Subscriber that knows how to handle rx.Observables which emits DataSources objects
 */
...
/**
 * Takes queryAlcoholic server-side Retrofit response and wraps it into queryAlcoholic DataSource
 */
...
/**
 * Extended function that knows how to turn an HTML response into queryAlcoholic Json response. Use this function if you want to perform webscrapping
 * over queryAlcoholic website and turn that into queryAlcoholic json response as if you were directly hitting queryAlcoholic server endpoint.
 */
