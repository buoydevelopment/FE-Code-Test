package com.solarabehety.cocktailapp.tracking;
...
public class ThrottleTrackingBus {
    ...
    private static final int THRESHOLD_MS = 150;

    private Subject<VisibleState, VisibleState> publishSubject;
    private Subscription subscription;
    private final Action1<VisibleState> onSuccess;

    public ThrottleTrackingBus(final Action1<VisibleState> onSuccess, final Action1<Throwable> onError) {
    ...
    public static class VisibleState {
        ...
        public VisibleState(int firstCompletelyVisible, int lastCompletelyVisible) {
